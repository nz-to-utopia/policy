...
<YouTubeEmbed videoId="6kTCrqDcXyE" title="AI's Quiet Disruption — Why NZ's Safe Jobs Aren't Safe Anymore" />

<Callout type="info">
This is a living document — if you have expertise in labour economics, workforce planning, or sector-specific knowledge, we'd welcome your contribution. <a href="/contribute/edit/ai-as-disruptor" className="underline hover:text-blue-700">Edit this page</a> or <a href="https://github.com/nz-to-utopia/policy/edit/main/ai-as-disruptor/index.mdx" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-700">edit on GitHub</a>.
</Callout>
...
- [Job Displacement](/ai-as-disruptor/job-displacement) — Analysis of which roles and sectors face the greatest risk
- [New Opportunities](/ai-as-disruptor/new-opportunities) — Emerging roles, industries, and economic possibilities
- [Timeline](/ai-as-disruptor/timeline) — Phased view of when changes are likely to arrive
