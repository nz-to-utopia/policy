...
<Callout type="info">
This is a living document — contribute your expertise. <a href="/contribute/edit/economic-landscape/technology" className="underline hover:text-blue-700">Edit this page</a> or <a href="https://github.com/nz-to-utopia/policy/edit/main/economic-landscape/technology.mdx" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-700">edit on GitHub</a>.
</Callout>
