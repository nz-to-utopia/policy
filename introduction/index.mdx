...
![A Culture-inspired vision of utopia — humans and AI living together in a lush green future](/content/introduction/culture-scene.png)
...
Every section can be edited, challenged, and improved by anyone. You don't need to be a developer, and you don't need to leave the site.

**To contribute:**

1. Read a section that interests you
2. Click **"Edit in browser"** at the bottom of the page
3. Make your changes in the editor that opens, write a short note explaining why, and submit
4. The community reviews and discusses your proposal
5. Accepted changes are merged and published

That's it. No accounts to set up, no tools to install, no git to learn. Just ideas, evidence, and a willingness to engage.

**For those who want to go deeper:** the document lives in a public [Git repository](https://github.com/nz-to-utopia/policy) where you can see the full history of every change, follow the debate on past proposals in [GitHub Discussions](https://github.com/nz-to-utopia/policy/discussions), or work directly with the source if you prefer that workflow.
